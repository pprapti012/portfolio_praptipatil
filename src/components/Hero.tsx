...
const Hero = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 gradient-primary rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-float" style={{
      animationDelay: '2s'
    }}></div>
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            <div className="mb-6">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-4 text-slate-200">
                <span className="bg-clip-text text-5xl text-indigo-200">Prapti Santosh
Patil</span>
                <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button size="lg" onClick={() => scrollToSection('#portfolio')} className="gradient-primary hover:shadow-button transition-smooth group">
                View Portfolio
                <ArrowDown className="ml-2 h-4 w-4 group-hover:translate-y-1 transition-transform" />
              </Button>
              <Button variant="outline" size="lg" onClick={() => scrollToSection('#contact')} className="border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-smooth">
            ...
            <div className="relative">
              ...
              <div className="relative w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden gradient-card p-2 shadow-glow">
                <div className="w-full h-full rounded-full overflow-hidden">
                  <img src={`${profilePicture}?v=${Date.now()}`} alt="Prapti Santosh Patil" className="w-full h-full object-cover scale-110 transition-transform duration-500 hover:scale-125" key={Date.now()} />
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-card border-2 border-primary rounded-full flex items-center justify-center animate-float" style={{
              animationDelay: '1s'
            }}>
